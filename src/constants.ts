...
export const VALIDATIONPROPS : validationProps[]= [
    {
        ...
        onTypes: ["text", "search", "url", "tel", "email", "password", "date", "month", "week", "time", "datetime-local", "number", "checkbox", "radio", "file"]
    },
    {
        name: "type",
